...
//!
//! Both `f32` and `f64` are targeted; `high_precision` is out of scope on the GPU backend
//! ([`GpuError::HighPrecisionUnsupportedOnGpu`]), and `f64` execution itself requires a device that
